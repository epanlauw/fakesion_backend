...
module.exports = {
  ...
  showImageItem: async (req, res) => {
    try {
      ...
      res.render("admin/item/view_item", {
        title: "Fakesion | Show Image Item",
        alert,
        item,
        action: "show-image",
      });
  ...
  editItem: async (req, res) => {
    try {
      ...
      if (req.files.length > 0) {
        // Jika update lebih/kurang imagenya error
  ...
  // Engga ngeremove dicategory itemIdnya
